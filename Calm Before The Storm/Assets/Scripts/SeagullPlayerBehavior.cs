...
public class SeagullPlayerBehavior : MonoBehaviour
{
    ...
    private Collider2D _seagullCollider;
    ...
    private void Start()
    {
        ...
        _seagullCollider = GetComponent<Collider2D>();
    ...
    private void OnEnable()
    {
        ...
        _seagullCollider = GetComponent<CapsuleCollider2D>();
        _seagullCollider.enabled = true;
        _seagullCollider.isTrigger = true;
